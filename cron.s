...
CRON_STOP:
    ...
    # apaga os displays
    stwio   r0, DISPLAY_DATA(r8)  # escreve 0 nos displays de 7 segmentos (HEX3->HEX0)
...
CRON_UPDATE:
    ...
    beq     r16, r0, CRON_END
    # se CRON_PAUSED for 1, não faz nada
    ldb     r16, CRON_PAUSED(r0)
    addi    r17, r0, 1
...
CRON_DONE_CARRYOVER:
    ...
    stwio   r19, DISPLAY_DATA(r8)      # escreve nos displays de 7 segmentos (HEX3->HEX0)
